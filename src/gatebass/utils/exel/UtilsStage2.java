 ...
 * @param <T>
 */
public class UtilsStage2<T extends ParentControl> {

    public T t;

    public UtilsStage2(String fxml, boolean resizable, String title, Modality modality, Window owner) {
        try {
            ...
            Logger.getLogger(UtilsStage2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public UtilsStage2(Class clazz, boolean resizable, String title, Modality modality, Window owner) {
